...
def readConfig():
    ...
    dict_prob_yes = config_probs["dict_prob_yes"] if config_probs["dict_prob_yes"] else 1
    dict_prob_no = config_probs["dict_prob_no"] if config_probs["dict_prob_no"] else 0
...
def langIdentify(inputText, classifier):
    ...
    for line in inputText:
        ...
        # print('LINE 456 = ', blurb, mallet_output, blurb_dict)
        # return blurb, mallet_output, blurb_dict
